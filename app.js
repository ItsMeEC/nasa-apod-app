...
var date= data.date;
var elem = '<h2 style= "color: white; padding-top: 50px;"> '+ heading +' </h2><div id="picture-div"><img style= "height: 400px; width: 400px; margin-top: 50px; margin-bottom: 50px;" class="img-responsive nasa-img" src="'+ imageLink +'" /></a></div><div id="text-div"><p style= "color: white" > '+ descp +' </p></div>';
results.append(elem);
}
